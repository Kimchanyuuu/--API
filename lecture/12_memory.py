...
# - Memory는 Return 2가지로 Type으로 전달
# - return_messages=True 옵션을 주면 Message class로 받음(채탕으로 활동)
# - Fales면 Text로 출력
...
chain.predict(question="My name is kimchanyu")
chain.predict(question="I kive in Gang")
